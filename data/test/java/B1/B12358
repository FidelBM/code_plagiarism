...
//		doTask("taskSmallB", "/home/dev/Letöltések/B-small-practice.in", "/home/dev/Letöltések/B-small-practice.out", new CaseB());
...
//		doTask("taskLargeC", "/home/dev/Letöltések/C-large-practice.in", "/home/dev/Letöltések/C-large-practice.out", new CaseC());
