...
public class ProblemaC {
	...
	private final static String RUTA="C:/Users/Rafael/Documents/Estudio/OtherStuff/Google/CodeJam/ProblemaC/";
	
	public ProblemaC(){
		try {
			FileOutputStream fos=new FileOutputStream(new File(RUTA+"resultado.txt"));
			BufferedReader br=new BufferedReader(new FileReader(RUTA+"C-small-attempt3.in"));
	...
	public int analizar(String first, String second ){
...
//						System.out.println(uno+","+dos);
	...
	public String convert(int k, String primero){
		String acumulador="";
		for(int i=0;i<k;i++)	
		{
