...
public class ProblemaB {
	...
	private final static String RUTA="C:/Users/Rafael/Documents/Estudio/OtherStuff/Google/CodeJam/ProblemaB/";
	private tripletOfScore[] triples;
	
	public ProblemaB(){
		
		
		inicializarTripleOfScores();
		
		
		try {
			FileOutputStream fos=new FileOutputStream(new File(RUTA+"resultado.txt"));
			BufferedReader br=new BufferedReader(new FileReader(RUTA+"B-small-attempt0.in"));
	...
	private void inicializarTripleOfScores() {
