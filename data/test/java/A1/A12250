...
public class DancingWithTheGooglers {
    ...
    public static void main(String args[]) throws Exception {
        String inputPath = "C:\\myTestProj\\src\\codeJam\\B-small-attempt0.in";
        String outputPath = "C:\\myTestProj\\src\\codeJam\\B-small-attempt0.out";

        DancingWithTheGooglers dwg = new DancingWithTheGooglers();
        String[] str = dwg.readFromFile(inputPath);

        str = dwg.solution(str);
        dwg.writeToFile(outputPath, str);
    }
